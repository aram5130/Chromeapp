...
function onLoginSubmint(event) {
    ...
    paintGreetings(username);  // username을 인자로 받음.
}

function paintGreetings(username) {     // 반복해서 나오기 때문에 함수로 만듦
...
const savedUsername = localStorage.getItem(USERNAME_KEY);  //  localStorage 정보는 받아옴..
...
if (savedUsername === null) {
    ...
    paintGreetings(savedUsername);  // saveUsername을 인자로 받음.
}
