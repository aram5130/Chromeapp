...
const quote = document.querySelector("#quote span:first-child");   // span 의 첫번째
const author = document.querySelector("#quote span:last-child");       // span 의 마지막

const todaysQuote = quotes[Math.floor(Math.random() * quotes.length)];  //Math.floor 소수점을 제외한 정수, (Math.random() 랜덤 숫자, * quotes.length
